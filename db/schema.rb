...
ActiveRecord::Schema.define(version: 20_160_929_060_429) do
  ...
  add_index 'ranks', %w(website_id created_at), name: 'index_ranks_on_website_id_and_created_at', unique: true
  ...
  add_index 'websites', %w(url_name user_id), name: 'index_websites_on_url_name_and_user_id'
end
